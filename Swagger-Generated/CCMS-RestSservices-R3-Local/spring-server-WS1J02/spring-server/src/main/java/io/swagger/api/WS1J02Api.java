...
@Api(value = "WS1J02", description = "the WS1J02 API")
public interface WS1J02Api {

    @ApiOperation(value = "", nickname = "wS1J02", notes = "", response = ResponseBody.class, authorizations = {
    ...
    @RequestMapping(value = "/WS1J02",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    ResponseEntity<ResponseBody> wS1J02(@ApiParam(value = "" ,required=true )  @Valid @RequestBody RequestBody requestBody);

...
import io.swagger.model.WS1J02_RequestBody;
...
@Controller
public class WS1J02ApiController implements WS1J02Api {

    private static final Logger log = LoggerFactory.getLogger(WS1J02ApiController.class);
